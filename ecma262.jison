...
%s  identifier_start identifier_start_unicode decimal_digit_start single_string_start double_string_start
...
StringLiteral
  : SingleQuoteStart SingleStringCharacter SingleQuoteEnd {
    $$ = $1 + $2 + $3;
  }
  | DoubleQuoteStart DoubleStringCharacter DoubleQuoteEnd {
    $$ = $1 + $2 + $3;
  }
