module.exports = {
  ...
  handlers: [
    '$$ = new (require(\'./ast/CoverParenthesizedExpressionNode\'))([$2], { loc: this._$, lexer: yy.lexer })',
    '$$ = new (require(\'./ast/CoverParenthesizedExpressionNode\'))([], { loc: this._$, lexer: yy.lexer })',
