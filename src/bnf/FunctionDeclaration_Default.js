module.exports = {
  ...
  handlers: [
    ...
    '$$ = new (require(\'./ast/FunctionDeclaration\').FunctionDeclarationNode)(null, [], null, { loc: this._$, lexer: yy.lexer })',
    '$$ = new (require(\'./ast/FunctionDeclaration\').FunctionDeclarationNode)(null, [], $5, { loc: this._$, lexer: yy.lexer })',
    '$$ = new (require(\'./ast/FunctionDeclaration\').FunctionDeclarationNode)(null, $3, null, { loc: this._$, lexer: yy.lexer })',
    '$$ = new (require(\'./ast/FunctionDeclaration\').FunctionDeclarationNode)(null, $3, $6, { loc: this._$, lexer: yy.lexer })',
  ],
  subRules: [
