...
module.exports = {
  ...
  rules: ['BindingIdentifier', 'BindingIdentifier Initializer', 'BindingPattern Initializer'],
  ...
  subRules: [require('./BindingIdentifier'), require('./Initializer'), require('./BindingPattern')]
};