...
module.exports = {
  ...
  conditions: [''],
  rules: ['if ( Expression_In ) Statement_Return', 'if ( Expression_In ) Statement_Return else Statement_Return'],
  ...
  subRules: [require('./Statement_Return'), require('./Expression_In')]
};